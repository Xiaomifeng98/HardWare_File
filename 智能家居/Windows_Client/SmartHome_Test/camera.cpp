    ...
    ui(new Ui::Camera)
{
    ...
    mediaPlayer->setMedia(QUrl("rtsp://192.168.43.129/abc.mkv"));
    mediaPlayer->play();
}
...
void Camera::readHttpCameraData()
{
    qint32 len;
...
void Camera::on_pushButton_clicked()
{
    this->statu = START;
    this->currentLen = 0;
    QString httpUrl = "http://192.168.43.129:8080/?action=stream";

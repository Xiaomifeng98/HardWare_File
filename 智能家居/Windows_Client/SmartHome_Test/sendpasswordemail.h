#ifndef SENDPASSWORDEMAIL_H
#define SENDPASSWORDEMAIL_H
...
class SendPasswordEmail : public QMainWindow
{
    Q_OBJECT

public:
     SendPasswordEmail(QString smtphost, QString smtpusername, QString smtppass);
     ~SendPasswordEmail();

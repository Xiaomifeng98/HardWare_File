...
SendPasswordEmail::SendPasswordEmail(QString smtphost, QString smtpusername, QString smtppass)
{
...
bool SendPasswordEmail::Send(const QString &to, const QString &subject, const QString &body)
{
    qDebug()<<"####"<<Q_FUNC_INFO;
    bool res = false;
    int waittime = 5 * 1000;
...
bool SendPasswordEmail::ReadLiner()
{
    bool res = false;
    if (isconnect)
    {
...
void SendPasswordEmail::ErrorCloseAll()
{
    delete t;
    smtpsocket->close();
}

bool SendPasswordEmail::PutSendLine()
{
...
QString SendPasswordEmail::SendLineAndGrab(QString senddata)
{
...
QString SendPasswordEmail::encodeBase64(QString xml)
{
    QByteArray text;
    text.append(xml);
...
QString SendPasswordEmail::decodeBase64(QString xml)
{
    QByteArray xcode("");;
    xcode.append(xml);
...
int SendPasswordEmail::dateswap(QString form, uint unixtime)
{
    QDateTime fromunix;
...
QString SendPasswordEmail::TimeStampMail()
{
